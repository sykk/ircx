...
export default tseslint.config(
  ...
  // The run harness is Node tooling rather than application source. Linting it
  // against browser globals reports `process` and `setTimeout` as undefined.
  { ignores: ["dist", "target", ".claude", "scripts/run-ircx", "src/types/generated", "crates/**"] },
