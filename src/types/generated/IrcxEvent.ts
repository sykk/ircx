 ...
 */
export type IrcxEvent = { "type": "networkUpdated", network: Network, } | { "type": "networkRemoved", network: string, } | { "type": "connectionChanged", network: string, status: ConnectionStatus, } | { "type": "saslChanged", network: string, status: SaslStatus, } | { "type": "capsChanged", network: string, enabled: Array<string>, } | { "type": "messagesAppended", network: string, target: string, messages: Array<ChatMessage>, answers: string | null, } | { "type": "messageUpdated", message: ChatMessage, } | { "type": "channelUpdated", channel: Channel, } | { "type": "channelRemoved", network: string, name: string, } | { "type": "queryUpdated", query: Query, } | { "type": "readMarkerUpdated", network: string, target: string, timestamp: string, } | { "type": "queryRemoved", network: string, nick: string, } | { "type": "queryRenamed", network: string, from: string, to: string, } | { "type": "channelsListed", network: string, channels: Array<ChannelListing>, 
/**
